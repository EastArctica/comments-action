...
const ansi_to_1 = __importDefault(require("ansi-to"));
...
const round = (x) => {
    const rounded = Number(Math.round(Number(x + 'e2')) + 'e-2');
    return rounded;
};
const decorators = {
...
const handler = (ansi, opts) => {
    ...
    ansi.chunks.forEach(chunk => {
        ...
        const entified = he_1.default.encode(value, { decimal: false });
...
exports.default = ansi_to_1.default.plugin(SVG);
